...
class User extends Component {
  ...
  renderUser () {
    return <UserForm unblockUser={this.props.unblockUser} resendConfirmationEmail={this.props.resendUserConfirmationEmail} save={this.props.saveUser} delete={this.props.deleteUser} onChange={this.props.updateUserForm} user={this.props.userOverview.user} />;
  }
