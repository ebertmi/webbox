            ...
            <form className="form-inline">
              <div className="form-group">
                <div className="input-group">
                  <input defaultValue={this.props.searchQuery} onChange={this.handleSearchQuery.bind(this)} type="text" className="form-control" placeholder={this.props.placeholderText} />
                </div>
