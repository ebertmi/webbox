 ...
 * @param {any} error
 */
function validationfailAction (request, reply, source, error) {
...
module.exports = [
  {
    ...
    handler: genr(Course.getAutocomplete),
    config: {
    ...
    handler: genr(Embed.getAutocomplete),
    config: {
    ...
    handler: genr(Media.getImagesFromDocument),
    config: {
    ...
    method: 'POST',
    path: '/mediaupload',
    handler: genr(Media.imageupload),
    config: {
      id: 'mediaupload',
      auth: {
        mode: 'try',
    ...
    method: 'GET',
    path: '/embed-ajax/{id}',
    handler: genr(Embed.getEmbedAjax),
    config: {
      auth: {
        mode: 'try',
        scope: 'user'
    ...
    handler: genr(Embed.exportStatistics),
    config: {
