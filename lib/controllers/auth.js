      ...
      if (isEqual === false) {
        ...
        .then(() => {
          ...
          // Send notification email
              // Now send a mail
          let template = getGeneralEmailBody(Config.messages.registration.manualConfirmMessage, request.pre.user.email);

          MailService.sendHtmlEmail("trycoding.io Freischaltung", template, request.pre.user.email);
