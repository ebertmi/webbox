...
import VerificationTemplate from '../mail/verification_template';
...
export function* resendConfirmationEmail (request, reply) {
  ...
  try {
    ...
    const mail = VerificationTemplate.getResendVerificationEmailBody(confirmUrl, user.verification.token);
